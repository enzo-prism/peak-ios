...
- When you tap Auto-fill Conditions, the app sends the session time window and surf break coordinates (latitude/longitude) to Open-Meteo to retrieve marine + wind conditions. This request is only made when you trigger it.
- The request does not include your name, notes, gear, buddies, or any identifiers.
